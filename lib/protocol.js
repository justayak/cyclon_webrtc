...
function shuffle(cyclon) {
    setInterval(function () {
        ...
        if (partialView.size()  > 0 && !cyclon.isShuffleing) {
        ...
        } else if (cyclon.isShuffleing){
            console.warn('skip shuffle due to very long previous shuffle..');
        }
    }, cyclon.delta_t);
}
